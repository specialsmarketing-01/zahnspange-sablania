...
export const metadata: Metadata = {
  ...
  description: "Moderne Ordination für Kieferorthopädie in Wien: Ausstattung, Anfahrt und Atmosphäre der Praxis Zahnspange Sablania.",
  alternates: { canonical: `${SITE_URL}/unsere-ordination`, languages: { de: `${SITE_URL}/unsere-ordination`, en: `${SITE_URL}/en/practice` } },
};

export default function UnsereOrdinationPage() {
