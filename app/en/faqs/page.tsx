...
export const metadata: Metadata = {
  title: "FAQs",
  description: "Frequently asked questions about orthodontics, braces, costs and treatment at Zahnspange Sablania in Vienna.",
  alternates: { canonical: `${SITE_URL}/en/faqs`, languages: { de: `${SITE_URL}/faqs`, en: `${SITE_URL}/en/faqs` } },
};
