...
export const metadata: Metadata = {
  ...
  description: "Privacy policy of Zahnspange Sablania, Vienna. Information on the processing of personal data.",
  alternates: { canonical: `${SITE_URL}/en/privacy-policy`, languages: { de: `${SITE_URL}/datenschutz`, en: `${SITE_URL}/en/privacy-policy` } },
};
